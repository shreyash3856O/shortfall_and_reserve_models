...
export const ALL_TRANSLATIONS: Record<string, TranslationSchema> = {
  en: {
    ...
    common: {
      ...
      error: "Failed to connect to CaveKrave server",
    ...
    chat: {
      ...
      welcomeMessage: "CaveKrave AI Assistant active. I provide **real-time mine shortfall risk assessments**, SHAP root-cause attributions, prescriptive rules, equipment dispatch forecasts, and **geological reserve block estimates**.\n\nSelect a suggested query or ask anything about mine operations.",
  ...
  hi: {
    ...
    common: {
      ...
      error: "CaveKrave सर्वर से संपर्क विफल",
    ...
    chat: {
      ...
      welcomeMessage: "CaveKrave एआई सहायक सक्रिय है। मैं **वास्तविक समय खान कमी जोखिम**, SHAP मूल कारण, उपचारात्मक नियम, उपकरण प्रेषण पूर्वानुमान और **भूवैज्ञानिक भंडार अनुमान** प्रदान करता हूं।",
  ...
  mr: {
    ...
    chat: {
      ...
      welcomeMessage: "CaveKrave एआय सहाय्यक सक्रिय आहे. मी **थेट खाण तुटवडा धोका**, SHAP मूळ कारणे, सुधारात्मक नियम आणि **भूगर्भीय साठा अंदाज** प्रदान करतो.",
